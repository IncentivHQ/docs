...
<Steps>
  ...
  <Step title="Step 2: Enter Contact Details">
    ...
    **Optional Details:** You can add a profile picture, to personalize the contact.
    ...
    ![Add Contacts](/docs/images/AddContact1.jpeg)
  </Step>
...
# Video Tutorial: Add Contact

<iframe width="560" height="315" src="https://www.youtube.com/embed/qsLw908DdKA?si=POC6EUFu_G2kwbUA&amp;start=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>