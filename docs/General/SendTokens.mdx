...
<Steps>
  ...
  <Step title="Step 5: Transaction Confirmation">
    ...
    - After completion, you’ll earn a badge. The more transactions you send, the higher your badge tier.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/wFwrSD8CbGc?si=Wp5aZPiaCm_TsGVE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>