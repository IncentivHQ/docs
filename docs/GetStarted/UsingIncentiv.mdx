...
| **OG Badge**                      | Awarded for completing your first onchain transaction within the Incentiv ecosystem. Any confirmed transaction counts. | OG Badge                                        |
| **Papa Badge**                    | Earned by completing any onchain transaction on PapaPlay using the Incentiv network.                                    | Papa Badge                            |
