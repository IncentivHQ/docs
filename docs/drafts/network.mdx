...
<a href="javascript:void(0);" onclick="addIncentivNetwork()">
<img
  src="../images/AddNetwork.png"
  alt="Add Incentiv Network"
...
| **_RPC Endpoint_**     | https://rpc1.testnet.incentiv.io/<br />[https://rpc2.testnet.incentiv.io/](http://rpc3.testnet.incentiv.io/)                                                                     |
| **_Bundler Endpoint_** | [https://bundler.rpc1.testnet.incentiv.io/](http://bundler.rpc2.testnet.incentiv.io/)<br />[https://bundler.rpc2.testnet.incentiv.io/](http://bundler.rpc3.testnet.incentiv.io/) |
| **_Chain ID_**         | 28802                                                                                                                                                                            |
| **_Currency Symbol_**  | TCENT                                                                                                                                                                            |

To connect to the Incentiv Testnet Alpha (old), use the following configuration:

| **Name**         | **Incentiv Testnet V1**              |
| ---------------- | ------------------------------------ |
