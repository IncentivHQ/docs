...
<Card title="Hyperlane Nexus" icon="sparkles" href="https://nexus.hyperlane.xyz?destination=incentiv">
  Bridge
</Card>

<Card title="Hyperlane" icon="sparkles" href="https://docs.hyperlane.xyz">
  Documentation
</Card>
