---
title: "Incentiv Mainnet — Full Node Deployment Guide"
description: "This guide walks you through building, configuring, and running an Incentiv mainnet full node as a resilient `systemd` service. "
---
...
<Steps>
  <Step title="Prerequisites">
    ...
    # Install Go 1.22+ from golang.org (or your package manager if it ships 1.22+)
    ```
  </Step>
  ...
  <Step title="Account & Environment Setup">
    ...
    **Save your password** to a file that your `systemd` service can read:
  ...
  <Step title="Start & Manage the Node">
    ...
    <Check>
      _Your _**_Incentiv Mainnet node_**_ is now _**_running_**_._
    </Check>
  </Step>
</Steps>
