...
_`Note: Although some internal protective measures prevent transactions from
...
_`Note: This works only with geth v1.6.0 and above.`_
...
_`Note: You could also use a full-fledged geth node as a bootnode, but it's the less
recommended way.`_
