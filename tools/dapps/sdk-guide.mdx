...
```bash
npm install @incentiv/dapp-sdk ethers@^6.13.0
```
...
- `portal`: The Portal URL (e.g., "[https://portal.incentiv.io](https://testnet.incentiv.io)")
...
- **Incentiv Network**: [https://incentiv.io](https://incentiv.io)
- **Mainnet Portal**: [https://portal.incentiv.io](https://portal.incentiv.io)
