...
The **Incentiv BetaNet** is your starting point for building, testing, and exploring the Incentiv blockchain. It’s a safe, public environment where you can try out smart wallets, simulate real activity, configure bundlers, or simply learn how the protocol works.
...
To connect to the Incentiv BetaNet, use the following configuration:
