---
title: "Incentiv UI-SDK Implementation Guide"
description: "Frontend UI toolkit to trigger login, signing, and wallet connection with the Incentiv Portal."
icon: "code"
---
...
Account Abstraction ([ERC-4337](https://docs.erc4337.io/)) allows users to interact with smart contracts using smart contract wallets instead of Externally Owned Accounts (EOAs). This enables features like:
...
<AccordionGroup>
  <Accordion title="Registration" defaultOpen icon="address-card">
  ...
  <Accordion title="Usage" icon="message-captions">
...
Let us code these steps:

<Steps>
  <Step title="Step 1: Register the Passkey">
    ```javascript
  ...
  <Step title="Step 2: Complete Registration Flow">
  ...
  <Step title="Step 3: Login with Passkey">
    ```javascript
...
## <Icon icon="arrow-right-arrow-left" size={24} /> Transaction Operations
...
### <Icon icon="square-list" size={24} /> Batch Transactions
...
### <Icon icon="file-lock" size={24} /> Contract Deployment
...
## <Icon icon="gas-pump" size={24} />  Gas Management
...
## <Icon icon="list-ol" size={24} /> Basic Interactions
