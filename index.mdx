<img
  src="/logo/Incentiv White.svg"
  alt="Incentiv White"
  title="Incentiv White"
  style={{ width:"20%" }}
/>
...
<CardGroup cols={2}>
  <Card icon="circle-play" href="https://docs.incentiv.net/docs/GetStarted/UsingIncentiv" title="Using Incentiv">
    Get your Incentiv Jouney started
  </Card>
  <Card icon="rectangle-code" href="https://docs.incentiv.net/tools/dapps/sdk" title="Development Tools">
